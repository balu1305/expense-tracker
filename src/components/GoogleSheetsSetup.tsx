...
import { getGoogleSheetsSetupGuide, validateGoogleSheetsConfig } from '@/lib/googleSheets';
    ...
    <div className="card">
      ...
      <div className="space-y-4">
        <p className="text-gray-600 text-sm">
          Connect your expense tracker to Google Sheets for automatic data backup and advanced analysis.
        </p>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-2">
                Create a <code className="bg-gray-100 px-1 rounded">.env.local</code> file in your project root and add these variables.
              </p>
            </div>

            {/* Sample Sheet Structure */}
            <div>
              <h4 className="font-semibold text-gray-800 mb-2">Google Sheets Structure:</h4>
              <div className="overflow-x-auto">
                <table className="min-w-full border border-gray-200 rounded-lg">
                  <thead>
                    <tr className="bg-gray-50">
                      <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase border-b">Date</th>
                      ...
                      <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase border-b">ID</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr className="border-b">
                      <td className="px-4 py-2 text-sm text-gray-600">2024-01-15</td>
                      <td className="px-4 py-2 text-sm text-gray-600">Grocery Shopping</td>
                      <td className="px-4 py-2 text-sm text-gray-600">2500.00</td>
                      <td className="px-4 py-2 text-sm text-gray-600">Food</td>
                      <td className="px-4 py-2 text-sm text-gray-600">abc123def456</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              <p className="text-xs text-gray-500 mt-2">
                Your Google Sheet should have these exact column headers in the first row.
              </p>
            </div>
          </div>
        )}
